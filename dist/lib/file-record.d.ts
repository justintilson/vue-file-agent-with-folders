...
declare class FileRecord {
    static getFromRaw(rawFileRecord: RawFileRecord, options: Options, isSync: boolean): Promise<FileRecord> | FileRecord;
    ...
    static fromRawArraySync(rawFileRecords: RawFileRecord[], options: Options): FileRecord[];
